...
export type AppMode = 'clock' | 'stopwatch' | 'timer' | 'speed' | 'scanner' | 'radar' | 'orbit' | 'nav' | 'sonar' | 'decrypt' | 'water' | 'sleep' | 'zen' | 'level' | 'steps' | 'altimeter' | 'emf' | 'seismo' | 'lumen' | 'thermal' | 'nfc' | 'calendar';
